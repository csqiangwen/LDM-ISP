...
class SonyDataset_eval(data.Dataset):
    def __init__(self):
        super(SonyDataset_eval,self).__init__()

        self.root_path = Path('/disk1/wenqiang/Documents/data/LLIE/SID/Sony/SID_test_crop5000_stride5000_129_half_size')
    ...
    def __getitem__(self, index):
        ...
        long_raw_path = os.path.join(self.root_path, self.folder_list[index], 'long.ARW')
        ...
        return {'short_img': short_img, 'long_img': long_img, 'long_raw_path': long_raw_path, 'folder_name': self.folder_list[index]}

    def __len__(self):
        return self.img_num

    def name(self):
        return 'SID Sony Eval Dataset'
